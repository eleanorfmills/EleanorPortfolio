...
$("#joke-2").click( function(){$("#joke-2").html ("It gets a jalapeño face!");});
...
$("#joke-3").click( function () { $("#joke-3").append("It was two-tired"); });
...
$("#joke-4").click (function () { $("img").attr ("src", "http://i.imgur.com/ZCIkkze.jpg"); });
